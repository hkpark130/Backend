...
VALUES
    ...
    (103, 'DIR-N-101', 'PURCHASE', 'notebook.png', 4, 3, '테스트사용자B', '검토중', '신규 입사자', '페이지네이션 테스트 샘플 103'),
    ...
    (106, 'DIR-N-101', 'RETURN', 'notebook.png', 7, 1, '테스트사용자E', '반납진행', '장비 회수', '페이지네이션 테스트 샘플 106'),
    ...
    (109, 'DIR-N-101', 'MODIFY', 'notebook.png', 10, 4, '테스트사용자H', '변경진행', '그래픽 작업', '페이지네이션 테스트 샘플 109'),
    ...
    (113, 'DIR-N-101', 'PURCHASE', 'notebook.png', 4, 3, '테스트사용자L', '입고완료', '연구 개발', '페이지네이션 테스트 샘플 113'),
    ...
    (116, 'DIR-N-101', 'RETURN', 'notebook.png', 7, 1, '테스트사용자O', '반납보류', '장비 점검', '페이지네이션 테스트 샘플 116'),
    ...
    (119, 'DIR-N-101', 'MODIFY', 'notebook.png', 10, 4, '테스트사용자R', '변경보류', '그래픽 작업', '페이지네이션 테스트 샘플 119'),
